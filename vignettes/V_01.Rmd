---
title: "Author Transparent Functions To Extend The Ready4 Framework"
output: 
  ...
  pdf_document:
    ...
    number_sections: yes
vignette: >
  %\VignetteIndexEntry{Author Transparent Functions To Extend The Ready4 Framework}
...
#### Typical Usage
A `ready4fun_manifest` object is most efficiently created with the aid of the `make_pkg_desc_ls` and `make_manifest` functions.
