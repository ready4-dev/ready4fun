...
#' @description author.ready4fun_pkg_setup() is an Author method that writes files to local or remote locations. This method is implemented for the ready4 S4 class for package metadata required for package set-up. The function is called for its side effects and does not return a value.
...
#' @return Instance (ready4 S4 class for package metadata required for package set-up.)
...
{
    inst_ready4fun_pkg_setup <- write_package(x, dv_url_pfx_1L_chr = dv_url_pfx_1L_chr, 
