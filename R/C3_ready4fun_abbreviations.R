...
#' Make new ready4 S3 class for tibble object lookup table of abbreviations.
...
#' Make prototype ready4 S3 class for tibble object lookup table of abbreviations.
...
plural_lgl = plural_lgl) %>% ready4class::update_pt_fn_args_ls()
rlang::exec(tibble::tibble,!!!args_ls)
}
#' Validate ready4 S3 class for tibble object lookup table of abbreviations.
...
x}
#' Is ready4 S3 class for tibble object lookup table of abbreviations.
