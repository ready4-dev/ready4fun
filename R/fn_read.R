#' Read functions
#' @description read_fns() is a Read function that reads an R script into memory Specifically, this function implements an algorithm to read functions. The function returns Functions (a list of environments).
