...
#' Make new ready4 S4 class for package metadata required for initial package set-up step.
...
#' Make prototype ready4 S4 class for package metadata required for initial package set-up step.
...
path_to_pkg_rt_1L_chr = path_to_pkg_rt_1L_chr) %>% ready4class::update_pt_fn_args_ls()
rlang::exec(list,!!!args_ls)
}
#' Validate ready4 S4 class for package metadata required for initial package set-up step.
...
x}
#' Is ready4 S4 class for package metadata required for initial package set-up step.
