...
#
# SECOND BIT
# assert_fn_args_to_rnm_ls <- write_new_arg_sfxs(arg_nms_chr = c("input_chr_vec","exclude_if_match_chr_vec"),
#                                                  fn_type_1L_chr = "assert",
#                                                  dir_path_chr = "data-raw/fns",
#                                                  pkg_nm_1L_chr = "ready4fun")
# saveRDS(assert_fn_args_to_rnm_ls,"data-raw/assert_fn_args_to_rnm_ls.RDS")
# THIRD BIT
# force_fn_args_to_rnm_ls <- write_new_arg_sfxs(arg_nms_chr = paste0("package_nm_chr","_vec"),
...
#   write_new_arg_sfxs(fn_type_1L_chr = fn_type_1L_chr,
#                                                  dir_path_chr = "data-raw/fns",
#                                                  pkg_nm_1L_chr = "ready4fun")
...
# fn_args_to_rnm_ls <- make_short_long_nms_vec(long_vecs_chr = c("args_nm_chr_vec","replacements_chr_vec","sfxs_chr_vec"),
