...
make_manifest <- function(pkg_desc_ls,
  ...
  if(check_type_1L_chr == "ready4"){
    ...
    badges_lup <- badges_lup %>%
      tibble::add_case(badge_names_chr = "R-CMD-check",
                       label_names_chr = "CI",
  ...
  if(dir.exists(paste0(path_to_pkg_rt_1L_chr,"/tests"))){
    ...
    codecov_img_1L_chr <- paste0(codecov_url_1L_chr,
                                 "/branch/",
    ...
    badges_lup <- badges_lup %>%
      tibble::add_case(badge_names_chr = "test-coverage",
                       label_names_chr = "Tests",
                       badges_chr = testcov_badge_1L_chr) %>%
      tibble::add_case(badge_names_chr = "codecov",
                       label_names_chr = "Coverage",
                       badges_chr = codecov_badge_1L_chr)
    append_ls <- append(append_ls,
                        list(`test-coverage` = "Tests",
                             codecov = "Coverage"))
  }
