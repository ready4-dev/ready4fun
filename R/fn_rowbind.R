...
#' @description rowbind_all_tbs_in_r4_obj() is a Rowbind function that performs custom rowbind operations on table objects. Specifically, this function implements an algorithm to rowbind all a tibbles in a readyforwhatsnext S4 object.The function returns a tibbles (a readyforwhatsnext s4).
...
#' @description rowbind_tbs_in_r4_obj() is a Rowbind function that performs custom rowbind operations on table objects. Specifically, this function implements an algorithm to rowbind a tibbles in a readyforwhatsnext S4 object.The function returns a tibbles (a readyforwhatsnext s4).
#' @param tbs_r4 Tibbles (a readyforwhatsnext S4)
