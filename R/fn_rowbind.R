...
#' @description rowbind_all_tbs_in_r4_obj() is a Rowbind function that performs custom rowbind operations on table objects. Specifically, this function implements an algorithm to rowbind all tibbles in readyforwhatsnext s4 object. The function returns Tibbles (a readyforwhatsnext S4).
...
#' @description rowbind_tbs_in_r4_obj() is a Rowbind function that performs custom rowbind operations on table objects. Specifically, this function implements an algorithm to rowbind tibbles in readyforwhatsnext s4 object. The function returns Tibbles (a readyforwhatsnext S4).
#' @param tbs_r4 Tibbles (a readyforwhatsnext S4)
