...
Examples of how `ready4fun` functions integrate into package authoring workflows using `ready4pack` can be found in the DATASET file within the data-raw folder of any R package that extends the ready4 framework (see https://www.ready4-dev.com/toolkits/). For example, to see how `ready4fun_manifest` is used in the workflow to author the [ready4show](https://ready4-dev.github.io/ready4show/) package, view [this file in the source code](https://github.com/ready4-dev/ready4show/blob/master/data-raw/DATASET.R).
