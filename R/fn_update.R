...
#' @return Function documentation (a character vector of length 1)
...
#' Update functions documentation tibble character vector of length 1 vars
#' @description update_fns_dmt_tb_chr_vars_chr_vec() is an Update function that edits an object, while preserving core object attributes. Specifically, this function implements an algorithm to an update functions documentation a tibble character vector of length 1 vars. Function argument fns_dmt_tb specifies the object to be updated. Argument data_chr provides the object to be updated. The function returns a functions documentation (a tibble).
...
#' Update functions documentation tibble logical vector of length 1 vars
#' @description update_fns_dmt_tb_lgl_vars_chr_vec() is an Update function that edits an object, while preserving core object attributes. Specifically, this function implements an algorithm to an update functions documentation a tibble logical vector of length 1 vars. Function argument fns_dmt_tb specifies the object to be updated. Argument data_chr provides the object to be updated. The function returns a functions documentation (a tibble).
#' @param fns_dmt_tb Functions documentation (a tibble)
#' @param data_chr Data (a character vector of length 1)
#' @param new_ls New (a list)
#' @return Functions documentation (a tibble)
