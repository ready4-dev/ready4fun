...
make_arg_desc_spine <- function(argument_nm_1L_chr,
  ...
  arg_desc_spine_1L_chr <- ifelse(identical(match_1L_chr, character(0)),
    NA_character_,
    paste0(
      argument_nm_1L_chr %>% make_arg_title(
        match_chr = match_1L_chr,
        abbreviations_lup = abbreviations_lup,
...
make_arg_type_abbr_spine <- function(argument_nm_1L_chr,
                                     object_type_lup) {
  arg_type_1L_chr <- object_type_lup$short_name_chr[endsWith(
    argument_nm_1L_chr,
    object_type_lup$short_name_chr
  )]
  arg_type_abbr_spine_1L_chr <- ifelse(identical(
    character(0),
    arg_type_1L_chr
  ),
  NA_character_,
...
make_custom_dmt_ls <- function(args_ls_ls = NULL,
  ...
  if (!is.na(user_manual_fns_chr[1])) {
    inc_for_main_user_lgl_ls <- list(
      force_true_chr = user_manual_fns_chr,
      force_false_chr = NA_character_
    )
  }
  custom_dmt_ls <- list(
    args_ls_ls = args_ls_ls,
    desc_ls = desc_ls,
    ...
    ~ {
      ...
      if (inc_all_mthds_1L_lgl) {
        fns_dmt_tb <- fns_dmt_tb %>%
          dplyr::mutate(inc_for_main_user_lgl = dplyr::case_when(
            file_pfx_chr %in% c("grp_", "mthd_") ~ T,
...
make_fn_desc_spine <- function(fn,
  ...
  pfx_matches_chr <- fn_types_lup$fn_type_nm_chr[purrr::map_lgl(
    types_chr, # %>% Hmisc::capitalize()
    ~ startsWith(
      fn_title_1L_chr, # %>% tools::toTitleCase()
      .x
    )
  )]
  ...
  treat_as_1L_chr <- ifelse(is_generic_1L_lgl,
    "Generic", #
    ifelse(purrr::map_lgl(
      abbreviations_lup$short_name_chr,
    ...
    ifelse(treat_as_1L_chr == "Generic",
      ...
      ifelse(treat_as_1L_chr == "Method",
        paste0(
          ...
          abbreviations_lup$long_name_chr[purrr::map_lgl(
            abbreviations_lup$short_name_chr,
            ~ endsWith(fn_name_1L_chr, paste0(".", .x))
          )]
        ),
...
make_fn_dmt_spine <- function(fn_name_1L_chr,
  ...
  if (!fn_type_1L_chr %in% get_set_chr) {
    fn_dmt_spine_chr_ls <- make_std_fn_dmt_spine(
      fn_name_1L_chr = fn_name_1L_chr,
    ...
    fn_dmt_spine_chr_ls <- make_gtr_str_dmt_spine(
      fn_type_1L_chr = fn_type_1L_chr,
      fn_name_1L_chr = fn_name_1L_chr,
      class_name_1L_chr = class_name_1L_chr,
      doc_in_class_1L_lgl = doc_in_class_1L_lgl,
...
make_fn_dmt_tbl_tmpl <- function(fns_path_chr,
  ...
  if (is.null(fn_types_lup)) {
    fn_types_lup <- get_rds_from_pkg_dmt(
      fl_nm_1L_chr = "fn_types_lup",
      piggyback_to_1L_chr = dv_ds_nm_1L_chr
    )
  }
  if (is.null(object_type_lup)) {
  ...
  file_pfx_chr <- fns_dir_chr %>%
    stringr::str_replace("data-raw/", "") %>%
    switch("fns" = "fn_",
      "s3" = "C3_",
      "gnrcs" = "grp_",
      "mthds" = "mthd_",
...
make_lines_for_fn_dmt <- function(fn_name_1L_chr,
  ...
  fn_tags_spine_ls <- make_fn_dmt_spine(
    fn_name_1L_chr = fn_name_1L_chr,
    fn_type_1L_chr = fn_type_1L_chr,
    fn_title_1L_chr = fn_title_1L_chr,
    fn = fn,
  ...
  new_tag_chr_ls <- make_new_fn_dmt(
    fn_type_1L_chr = fn_type_1L_chr,
    fn_name_1L_chr = fn_name_1L_chr,
  ...
  fn_tags_chr <- update_fn_dmt(
    fn_tags_spine_ls = fn_tags_spine_ls,
...
make_manifest <- function(pkg_desc_ls,
  ...
  if (check_type_1L_chr == "ready4") {
    CI_url_1L_chr <- paste0("https://github.com/", gh_repo_1L_chr, "/actions/workflows/", "R-CMD-check.yaml")
    CI_img_1L_chr <- paste0(CI_url_1L_chr, "/badge.svg")
    CI_badge_1L_chr <- paste0("[![", "R-CMD-check", "](", CI_img_1L_chr, ")](", CI_url_1L_chr, ")")
    badges_lup <- badges_lup %>%
      tibble::add_case(
        badge_names_chr = "R-CMD-check",
        label_names_chr = "CI",
        badges_chr = CI_badge_1L_chr
      )
    append_ls <- append(
      append_ls,
      list(`R-CMD-check` = "CI")
  ...
  if (dir.exists(paste0(path_to_pkg_rt_1L_chr, "/tests"))) {
    ...
    codecov_badge_1L_chr <- paste0("[![", "codecov", "](", codecov_img_1L_chr, ")](", codecov_url_1L_chr, ")")
    badges_lup <- badges_lup %>%
      tibble::add_case(
        badge_names_chr = "test-coverage",
        label_names_chr = "Tests",
        badges_chr = testcov_badge_1L_chr
      ) %>%
      tibble::add_case(
        badge_names_chr = "codecov",
        label_names_chr = "Coverage",
  ...
  manifest_ls <- list(
    ...
    subsequent_ls = list(
      ...
      seed_obj_type_lup = get_rds_from_pkg_dmt(
        fl_nm_1L_chr = "seed_obj_type_lup",
        piggyback_to_1L_chr = piggyback_to_1L_chr
      ),
      server_1L_chr = server_1L_chr,
      s4_fns_ls = list(),
      treat_as_words_chr = get_rds_from_pkg_dmt(
        fl_nm_1L_chr = "treat_as_words_chr",
        piggyback_to_1L_chr = piggyback_to_1L_chr
      )
    )
  )
...
make_new_fn_dmt <- function(fn_type_1L_chr,
  ...
  new_fn_dmt_chr_ls <- list(
    desc_start_1L_chr = desc_start_1L_chr,
...
make_obj_lup_spine <- function(seed_obj_type_lup = get_rds_from_pkg_dmt(
                                 fl_nm_1L_chr = "seed_obj_type_lup",
...
make_obj_lup <- function(obj_lup_spine = make_obj_lup_spine()) {
  ...
  obj_tb <- dplyr::bind_rows(
    obj_tb %>%
      dplyr::mutate(long_name_chr = purrr::map2_chr(
        long_name_chr, atomic_element_lgl,
        ~ ifelse(.y, paste0(.x, " vector"), .x)
      )),
    obj_tb %>%
      dplyr::filter(atomic_element_lgl) %>%
      dplyr::mutate(
        short_name_chr = short_name_chr %>% purrr::map_chr(~ paste0(
          stringr::str_sub(.x, end = -5),
          "1L_",
  ...
  obj_tb <- dplyr::bind_rows(
    ...
    obj_tb %>%
      dplyr::mutate(
        short_name_chr = paste0(short_name_chr, "_ls"),
        long_name_chr = paste0("list of ", long_name_chr)
      ) %>%
      dplyr::bind_rows(obj_tb %>%
        dplyr::mutate(
          short_name_chr = paste0(short_name_chr, "_r4"),
...
make_ret_obj_desc <- function(fn,
  ...
  if (is.na(ret_obj_nm_1L_chr)) {
    ...
    ret_obj_desc_1L_chr <- paste0(
      ifelse(ret_obj_nm_1L_chr == "x",
        ret_obj_nm_1L_chr,
        ifelse(obj_type_1L_chr == "An object",
          ret_obj_nm_1L_chr,
          ret_obj_nm_1L_chr %>% make_arg_title(
            match_chr = obj_type_1L_chr,
            abbreviations_lup = abbreviations_lup,
            object_type_lup = abbreviations_lup
          ) %>%
...
make_std_fn_dmt_spine <- function(fn_name_1L_chr,
                                  ...
                                  piggyback_to_1L_chr = "ready4-dev/ready4") {
  assert_inp_does_not_match_terms(
    input_chr = fn_type_1L_chr,
  ...
  if (startsWith(fn_type_1L_chr, "gen_")) {
    ...
    fn_tags_1L_chr <- sinew::makeOxygen(fn,
      print = FALSE,
      add_fields = c(
        ifelse(!is.na(details_1L_chr), "details", NA_character_),
  ...
  if (!fn_type_1L_chr %>% startsWith("s3") & !fn_type_1L_chr %in% c(
    "fn",
    "gen_std_s3_mthd",
    "meth_std_s3_mthd",
    "gen_std_s4_mthd",
    ...
    fn_tags_1L_chr <- update_fn_dmt_with_slots(
      fn_name_1L_chr = fn_name_1L_chr,
      fn_dmt_1L_chr = fn_tags_1L_chr
    )
  }
  std_fn_dmt_spine_chr_ls <- list(
    fn_tags_1L_chr = fn_tags_1L_chr,
    ref_slot_1L_chr = fn_name_1L_chr
  )
