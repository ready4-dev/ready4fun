...
#' @rdname remove_obj_type_from_nm_chr
#' @export 
#' @importFrom purrr map2_chr map_lgl
#' @importFrom stringr str_remove
#' @importFrom stringi stri_replace_last_fixed
#' @keywords internal
remove_obj_type_from_nm_chr <- function (nms_chr_vec, object_type_lup = NULL, abbreviations_lup = NULL, 
    is_generic_lgl_vec = F) 
{
    ...
    output_chr_vec <- make_arg_type_abbr_chr(nms_chr_vec, 
