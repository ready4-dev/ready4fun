...
#' Make prototype ready4fun package manifest two ready4 S3 class for package metadata required for second package set-up step.
...
#' Validate ready4fun package manifest two ready4 S3 class for package metadata required for second package set-up step.
...
x}
#' Is ready4fun package manifest two ready4 S3 class for package metadata required for second package set-up step.
