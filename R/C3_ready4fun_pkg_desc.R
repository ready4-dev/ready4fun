...
#' Make new ready4 S4 class for declaring package description file data.
...
#' Make prototype ready4 S4 class for declaring package description file data.
...
License = License,
URL = URL) %>% ready4class::update_pt_fn_args_ls()
rlang::exec(list,!!!args_ls)
}
#' Validate ready4 S4 class for declaring package description file data.
...
x}
#' Is ready4 S4 class for declaring package description file data.
