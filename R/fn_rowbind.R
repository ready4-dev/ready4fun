#' @keywords internal
rowbind_all_tbs_in_r4_obj_r4 <- function (tbs_r4, second_tbs_r4, r4_name_1L_chr) 
{
...
#' @keywords internal
rowbind_tbs_in_r4_obj_r4 <- function (tbs_r4, slot_nm_1L_chr, second_tbs_r4, r4_name_1L_chr) 
{
