...
#' Make new ready4 S4 class for package metadata required for package set-up.
...
#' Make prototype ready4 S4 class for package metadata required for package set-up.
...
subsequent_ls = subsequent_ls) %>% ready4class::update_pt_fn_args_ls()
rlang::exec(list,!!!args_ls)
}
#' Validate ready4 S4 class for package metadata required for package set-up.
...
x}
#' Is ready4 S4 class for package metadata required for package set-up.
